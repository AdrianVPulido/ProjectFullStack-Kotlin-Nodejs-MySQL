...
class DbManager {
    ...
    //Create Table
    val sqlCreateTable = "CREATE TABLE IF NOT EXISTS $dbTable($colID INTEGER PRIMARY KEY AUTOINCREMENT,$colIDM INTEGER NOT NULL,$colestado VARCHAR(50) NOT NULL, $colNombre VARCHAR(200) NOT NULL)"
